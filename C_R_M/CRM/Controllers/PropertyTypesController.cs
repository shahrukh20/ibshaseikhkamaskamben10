...
namespace CRM.Controllers
{
    public class PropertyTypesController : Controller
    {
        ...
        public string PropertyTypeAjax()
        {
            try
            {

                return JsonConvert.SerializeObject(db.PropertyTypes.Select(x => new 
                {
                    PropertyId = x.Id,
                    Name = x.Name
                }
        ...
        public ActionResult Create([Bind(Include = "Id,Name")] PropertyType propertyType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name")] PropertyType propertyType)
        {
            if (ModelState.IsValid)
            {
